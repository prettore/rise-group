...
const translations = {
    'pt-BR': {
        ...
        'pub.title': 'Produção Científica',
        'pub.subtitle': 'Conheça as publicações do RISE Group em conferências e periódicos de excelência internacional.',
        'pub.total': 'Artigos Publicados',
        'pub.conferences': 'Em Conferências',
        'pub.journals': 'Em Periódicos',
        'pub.th_title': 'Título & Evento/Revista',
        'pub.th_type': 'Tipo',
        'pub.th_qualis': 'Qualis/Ano',
        'pub.th_link': 'Link',
        'partners.institutions': 'Instituições Colaboradoras',
        'partners.sponsors': 'Agências de Fomento',
    ...
    'en': {
        ...
        'pub.title': 'Scientific Production',
        'pub.subtitle': 'Discover RISE Group publications in international conferences and journals of excellence.',
        'pub.total': 'Published Articles',
        'pub.conferences': 'In Conferences',
        'pub.journals': 'In Journals',
        'pub.th_title': 'Title & Venue/Journal',
        'pub.th_type': 'Type',
        'pub.th_qualis': 'Qualis/Year',
        'pub.th_link': 'Link',
        'partners.institutions': 'Collaborating Institutions',
        'partners.sponsors': 'Funding Agencies',
